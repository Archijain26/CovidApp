...
public class Coviddataservice {
    ...
    public Integer getCovidData(String cityName)
    {
        ...
        stateCityMap.put("Indore","Madhya Pradesh");
        stateCityMap.put("Ujjain","Madhya Pradesh");
        stateCityMap.put("New Delhi","Uttar Pradesh");
        stateCityMap.put("Hoshangabad","Madhya Pradesh");
